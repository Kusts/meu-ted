...
export const recordSourceEnum = pgEnum('record_source', ['whatsapp', 'dashboard', 'cron', 'agent', 'reimbursement']);
...
export const ledgerEntryTypeEnum = pgEnum('ledger_entry_type', ['cash', 'card_charge', 'invoice_payment', 'transfer', 'interest', 'adjustment', 'recurrence', 'reimbursement']);
