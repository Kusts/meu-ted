...
| CAP-006 | `get_pending_operation` | Read a pending high-value operation for a chat | agent/operator | event-driven | low | No route | No dedicated surface | chat | chat-only | query | — | — | — | — | — | none | planned |
...
| CAP-019 | `confirm_pending_operation` | Approve and execute a pending operation | agent/operator | event-driven | critical | No route | No dedicated surface | chat | chat-only | command | — | — | — | — | — | policy | planned |
| CAP-020 | `cancel_pending_operation` | Cancel a pending operation | agent/operator | event-driven | critical | No route | No dedicated surface | chat | chat-only | command | — | — | — | — | — | policy | planned |
| CAP-021 | `undo_last_action` | Undo the latest eligible mutation | member/owner | on-demand | critical | No route | No dedicated surface | chat | chat-only | command | — | — | — | — | — | policy | planned |
