...
import { splitInstallmentAmounts } from '../../src/cards/installments.js';

describe('splitInstallmentAmounts (L-01 contract)', () => {
  ...
  it('absorbs the remainder in the LAST parcel so parts sum to the total', () => {
    // 1000/3: Math.round would give 333×3=999 (drift); contract gives 333+333+334.
