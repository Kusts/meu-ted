...
export const suggestBudgetAdjustmentTool = { name: "suggest_budget_adjustment", description: "Sugere ajuste de or̤amento.", parameters: Type.Object({ householdId: Type.Optional(Type.String()), budgetId: Type.String() }), execute: async () => capabilityDisabled("suggest_budget_adjustment") ?? { success: false, reason: "Capability suggest_budget_adjustment has no API route yet" } };
