...
const outputPath = argValue('--out', path.join(root, '.pi', 'extensions', 'financial-tools', 'generated', 'http-tools.ts'));
...
const parameterEntries = (spec) => spec.parameters.map((parameter) =>
...
import { capabilityDisabled } from "../tools/api-tool-helpers.js";
